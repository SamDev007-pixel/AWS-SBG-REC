...
async function main() {
  ...
  const event1 = await prisma.event.upsert({
    ...
    update: {
      ...
      category: 'Bootcamp',
      shortDescription: 'Experience a day of Cloud, Code, Community and Innovation with AWS Heroes and architects!',
      description: 'Join developers, cloud enthusiasts, and tech leaders from across the region. Features deep-dive technical talks, interactive labs, and panels led by AWS Heroes, User Group leaders, and industry practitioners.',
      posterImage: '/events/community_day.jpg',
    ...
    create: {
      ...
      agenda: {
        create: [
          { title: 'Welcome Keynote & Cloud Trends', speaker: 'AWS Heroes', startTime: '09:30', endTime: '10:30' },
          { title: 'Hands-on Builders Workshop', speaker: 'Architect Team', startTime: '10:30', endTime: '12:30' },
          { title: 'Networking & Lunch break', speaker: null, startTime: '12:30', endTime: '13:30' },
          { title: 'Breakout Sessions: DevOps, AI/ML & Security', speaker: 'Industry Mentors', startTime: '13:30', endTime: '15:30' },
          { title: 'Closing Notes & Quiz Giveaways', speaker: 'Core Team', startTime: '15:30', endTime: '17:00' },
        ],
      },
      speakers: {
        create: [
          {
            ...
            role: 'Tech Leaders & Community Heroes',
            organization: 'AWS Community',
            bio: 'AWS Community Heroes sharing best practices and real-world architectures.',
      ...
      formFields: {
        create: [
          { label: 'Year of Study', type: 'DROPDOWN', isRequired: true, fieldOrder: 0, options: { values: ['1st Year', '2nd Year', '3rd Year', '4th Year', 'Other'] } },
          { label: 'Department', type: 'TEXT', isRequired: true, fieldOrder: 1 },
          { label: 'T-shirt Size', type: 'DROPDOWN', isRequired: false, fieldOrder: 2, options: { values: ['S', 'M', 'L', 'XL', 'XXL'] } },
        ],
      },
    },
  });
  ...
  const event2 = await prisma.event.upsert({
    ...
    update: {
      ...
      category: 'Workshop',
      shortDescription: 'Where robotics meets cloud intelligence. Workshop on DOBOT and Computer Vision Integration with AWS.',
      description: 'TRS REC x AWS REC present a workshop on DOBOT and Computer Vision Integration with AWS. Learn how containerized workloads and AWS IoT Greengrass connect robotic platforms to vision models.',
      posterImage: '/events/robowolke.jpg',
      venue: 'ANEW104, Rajalakshmi Engineering College',
      mode: 'OFFLINE',
      capacity: 200,
      date: new Date('2026-04-29T09:00:00Z'),
      time: '09:00',
    ...
    create: {
      ...
      agenda: {
        create: [
          { title: 'Computer Vision & AWS IoT Introduction', speaker: 'TRS & AWS Leads', startTime: '09:00', endTime: '10:30' },
          { title: 'Interactive Dobot Programming Lab', speaker: 'Hardware Engineers', startTime: '10:30', endTime: '12:30' },
          { title: 'Deployment & Integration', speaker: 'Mentors', startTime: '12:30', endTime: '14:00' },
        ],
      },
      speakers: {
        create: [
          {
            name: 'TRS x AWS Technical Leads',
            role: 'Robotics & Cloud Mentors',
            organization: 'REC',
            bio: 'Expert team bridging edge robotics with cloud intelligence.',
          },
        ],
      },
    },
  ...
  const event3 = await prisma.event.upsert({
    ...
    update: {
      title: 'Cloud Matrix - Careers & Certifications',
      category: 'Seminar',
      shortDescription: 'Cloud Computing - From Basics to Careers & AWS Certifications.',
      description: 'Learn cloud fundamentals, career paths, and AWS certifications in one comprehensive session hosted by AWS Cloud Club REC.',
      posterImage: '/events/cloud_matrix.jpg',
      venue: 'ANEW104, Rajalakshmi Engineering College',
      mode: 'OFFLINE',
      capacity: 150,
    ...
    create: {
      ...
      agenda: {
        create: [
          { title: 'Introduction to Cloud Concepts', speaker: 'Cloud Club Leads', startTime: '08:00', endTime: '08:30' },
          { title: 'AWS Certification Maps & Preparation', speaker: 'Certified Architects', startTime: '08:30', endTime: '09:30' },
          { title: 'Q&A and Resource Distribution', speaker: null, startTime: '09:30', endTime: '10:00' },
        ],
      },
    },
  });
  ...
  const event4 = await prisma.event.upsert({
    where: { id: 'event-seed-004' },
    update: {
      title: 'Investiture Ceremony 2026',
      category: 'Workshop',
      shortDescription: 'Join us as we step into a new chapter of innovation, collaboration and leadership with AWS Cloud Club REC.',
      description: 'This marks the formal establishment of the AWS Cloud Club REC student chapter. Introduction of office bearers, annual roadmap, and introductory cloud session.',
      posterImage: '/events/investiture.jpg',
      venue: 'ANEW201, Rajalakshmi Engineering College',
      mode: 'OFFLINE',
      capacity: 150,
      date: new Date('2026-02-21T09:30:00Z'),
      time: '09:30',
  ...
  console.log('Created 4 official events');
