  ...
  if (checkingAuth) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-3">
        <div className="w-9 h-9 rounded-full border-2 border-amber-100 border-t-[#FF9900] animate-spin" />
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {loading && topics.length === 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div key={n} className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-2xs animate-pulse space-y-4">
                <div className="flex items-center justify-between">
                  <div className="w-16 h-4 bg-amber-100/60 rounded-md" />
                  <div className="w-12 h-4 bg-slate-100 rounded-md" />
                </div>
                <div className="space-y-2">
                  <div className="w-3/4 h-5 bg-slate-200/70 rounded-md" />
                ...
                <div className="pt-3 border-t border-slate-100 flex justify-between items-center">
                  ...
                  <div className="w-20 h-4 bg-amber-100/60 rounded-md" />
                </div>
              </div>
            ))}
          </div>
