...
export const IntermediateCloudsOverlay: React.FC<IntermediateCloudsOverlayProps> = ({
  ...
  const clouds = [
    { id: 'cloud-1', left: '8%', top: '120px', width: 360, height: 160, driftX: [-10, 15, -10], driftY: [-5, 8, -5], duration: 14, grad: 'grad-dark', partDir: -1, exitY: -90, delay: 0 },
    { id: 'cloud-2', left: '22%', top: '450px', width: 400, height: 170, driftX: [-15, 20, -15], driftY: [-8, 10, -8], duration: 18, grad: 'grad-medium', partDir: -1, exitY: 70, delay: 0.15 },
    { id: 'cloud-3', left: '60%', top: '750px', width: 380, height: 160, driftX: [15, -15, 15], driftY: [-6, 6, -6], duration: 16, grad: 'grad-light', partDir: 1, exitY: -80, delay: 0.28 },
    { id: 'cloud-4', left: '48%', top: '1050px', width: 410, height: 180, driftX: [20, -10, 20], driftY: [-8, 12, -8], duration: 20, grad: 'grad-dark', partDir: 1, exitY: 90, delay: 0.40 },
    { id: 'cloud-5', left: '5%', top: '1350px', width: 370, height: 160, driftX: [-12, 12, -12], driftY: [-5, 10, -5], duration: 15, grad: 'grad-medium', partDir: -1, exitY: -60, delay: 0.52 },
  ];
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {locked && (
          <>
            {/* Soft atmospheric mist overlay lifting upward */}
            <motion.div
              initial={{ opacity: 0 }}
              ...
              className="absolute inset-0 bg-slate-900 pointer-events-none origin-top"
            />
            ...
            >
              ...
              <p className="text-xs text-slate-400 font-medium leading-relaxed max-w-[280px]">
                Hidden in grey clouds. Complete all Beginner modules to disperse the storm.
              </p>
            </motion.div>
          </>
        )}
