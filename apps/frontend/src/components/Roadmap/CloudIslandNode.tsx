  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          {status === 'locked' ? (
            ...
            <g>
              ...
              <path
                d="M 30,73 L 150,73 L 130,105 L 90,132 L 50,105 Z"
              ...
              {/* 3. CLOUD LAYER */}
              <path
                d="M 50,70 C 32,70 28,55 40,45 C 28,35 42,20 65,25 C 75,10 105,12 115,28 C 135,18 147,38 137,58 C 147,70 132,82 115,82 C 98,86 78,86 65,82 C 52,82 50,76 50,70 Z"
        ...
        {/* Node Content Nested Inside the Cloud Layer */}
        {status !== 'locked' ? (
