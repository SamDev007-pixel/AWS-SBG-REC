        ...
        {locked && (
          <>
            ...
            >
              ...
              <div className="w-12 h-0.5 bg-gradient-to-r from-transparent via-slate-600 to-transparent my-2" />
              <p className="text-xs text-slate-400 font-medium leading-relaxed max-w-[280px]">
                Hidden in deep storm clouds. Complete all Intermediate modules to disperse the storm.
              </p>
            </motion.div>
          </>
        )}
