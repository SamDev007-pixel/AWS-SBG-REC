  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-50 border border-blue-200 text-blue-800 text-xs font-semibold rounded-2xl p-4 flex items-center justify-center gap-2 w-full max-w-md">
        ...
        <span>Quiz Unlocked! Multiple-choice questions ahead.</span>
      </div>

      <button
        onClick={onTakeQuiz}
        className="w-full max-w-xs bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-6 rounded-xl text-xs tracking-wider transition-all active:scale-[0.98] shadow-md shadow-blue-600/15 cursor-pointer"
      >
        Take Quiz
      </button>
    </motion.div>
